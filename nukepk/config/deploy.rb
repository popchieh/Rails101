...
role :web, "nukepk.com"                          # Your HTTP server, Apache/etc
role :app, "nukepk.com"                         # This may be the same as your `Web` server
role :db,  "nukepk.com"   , :primary => true # This is where Rails migrations will run
